# Iportando as bibliotecas matplotlib para construção e visualização de grafico
...
# dados do 3 gráfico, idh.
ax3.plot(am['ano'],am['idhbr'],label='brasil',marker='o')
ax3.plot(am['ano'],am['idhlux'],label='luxemburgo',marker='o')
ax3.plot(am['ano'],am['idhphl'],label='filipinas',marker='o')
ax3.plot(am['ano'],am['usa'],label='estados unidos',marker='o')
ax3.plot(am['ano'],am['idhw'],label='global',marker='o')

# Definindo limites para os eixos x e y.
ax3.set_xlim(1999,2025)
ax3.set_ylim(0,1)

# Detalhes do grafico 1 como titulo, rotulos dos eixos x e y, legendas e grade.
ax3.set_title('IDH ao decorrer dos anos')
ax3.set_xlabel('ano')
ax3.set_ylabel('IDH')
ax3.legend(title='IDH')
ax3.grid(True)
